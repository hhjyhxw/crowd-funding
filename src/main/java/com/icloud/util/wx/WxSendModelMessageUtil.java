...
public class WxSendModelMessageUtil {
	...
	public static void main(String[] args) {
		...
		keyword1.put("value", "酷派 Cool Changer 1C");
		//消费金额
		JSONObject keyword2 = new JSONObject();
		keyword2.put("value", "2017-06-05 10:00:00");
		//备注
		...
		String openId  = "oREekjpdKKzCawu1e51-fsz8jito";
		String modelId = "YaWoZqey-1r7yYLTy4paS5JyXLoW5PztPniw_cdBH7s";
		
		jsonObj.put("template_id", modelId);
		jsonObj.put("url","http://wx.thewm.cn/crowdweb/raisewx/raiseCenter");
